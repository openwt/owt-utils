...
public final class XmlUtils
{
    ...
    private static final SAXHandlerFactory FACTORY = factory -> new SAXHandler()
    {
        ...
        public void startElement(
                final String namespaceURI, final String localName, final String qName, final Attributes atts) throws SAXException
        {
    ...
    public static String findAttributValue(final Object document, final String xpathExpression)
    {
